...
import polonium.com.kotlinexample.scan.mycapture.GraphicOverlay.Graphic
import java.util.*
...
class GraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val mGraphics = HashSet<BarcodeGraphic>()
    var isShowText: Boolean = false
    var isDrawRect: Boolean = false
    var rectColors: Array<Int>? = null

    /**
     * Returns a copy (as a list) of the set of all active graphics.
     * @return list of all active graphics.
     */
    val graphics: List<BarcodeGraphic>
     ...
     */
    fun add(graphic: BarcodeGraphic) {
        synchronized(mLock) {
     ...
     */
    fun remove(graphic: BarcodeGraphic) {
        synchronized(mLock) {
